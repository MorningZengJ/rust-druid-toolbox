...
impl VideoToolEngine {
    ...
    fn generate_jpeg_cover_from_video(video_path: &std::path::Path) -> Result<(Vec<u8>, u32, u32)> {
        ...
        // 计算 seek 时间：视频时长 ≥ 2 秒则 seek 到 1 秒处
